...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    Title="フォルダナビゲーター v3.5 - Phase 3.5" Width="1400" Height="800"
    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#34495e" Padding="10">
            <StackPanel>
                <TextBlock Text="フォルダナビゲーター + リネーム + D&amp;D + ブックマーク + Excel + 削除" FontSize="18" FontWeight="Bold" 
        ...
        <Border Grid.Row="3" Background="#ecf0f1" Padding="10">
            <Grid>
                ...
                <StackPanel Grid.Column="1" Orientation="Horizontal">
                    ...
                    <Button Name="btnDelete" Content="削除" Padding="10,5" Margin="5" MinWidth="100"
...
Write-Host "  ✅ ファイル削除機能（安全版）" -ForegroundColor Green
