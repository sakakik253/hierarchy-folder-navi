...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    Title="フォルダナビゲーター v3.3 - Phase 3.3" Width="1400" Height="800"
    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#34495e" Padding="10">
            <StackPanel>
                <TextBlock Text="フォルダナビゲーター + 一括リネーム + ドラッグ&amp;ドロップ + ブックマーク" FontSize="18" FontWeight="Bold" 
...
Write-Host "  ✅ ブックマーク機能" -ForegroundColor Green
