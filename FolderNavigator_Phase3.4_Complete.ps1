...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    Title="フォルダナビゲーター v3.4 - Phase 3.4" Width="1400" Height="800"
    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#34495e" Padding="10">
            <StackPanel>
                <TextBlock Text="フォルダナビゲーター + 一括リネーム + D&amp;D + ブックマーク + Excel出力" FontSize="18" FontWeight="Bold" 
...
Write-Host "  ✅ Excel/CSV出力機能" -ForegroundColor Green
